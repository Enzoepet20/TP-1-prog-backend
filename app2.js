...
class CentroEducativo {
    ...
    validarFormulario(e) {
        ...
        if(this.nombreInput.value === '' || this.apellidosInput.value === '' || this.estadoCivilInput.value === ''|| this.anoIncorporacion.value === ''|| this.numeroDespacho.value === ''|| this.departamento.value === '' ) {
        ...
        if(editando) {
            ...
            this.agregarEmpleado(profesor);
        }
    }

    agregarEmpleado(profesor) {
        listaEmpleados.push({...profesor});
    ...
    mostrarEmpleados() {
        ...
        listaEmpleados.forEach(empleado => {
            const {id, nombre, apellidos, estadoCivil, anoIncorporacion, numeroDespacho, departamento} = empleado;

            const parrafo = document.createElement('p');
            parrafo.textContent = `${id} - ${nombre} - ${apellidos} - ${estadoCivil} - ${anoIncorporacion} - ${numeroDespacho} - ${departamento}`;
    ...
    editarEmpleado() {
        ...
        listaEmpleados = listaEmpleados.map(empleado => {
            if(empleado.id === id) {
                return { ...empleado, nombre, apellidos, estadoCivil, anoIncorporacion, numeroDespacho, departamento };
            } else {
                return empleado;
            }
        });
